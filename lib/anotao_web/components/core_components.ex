defmodule AnotaoWeb.CoreComponents do
  @moduledoc """
  ...
  def flash_group(assigns) do
    ...
    <div id={@id}>
      ...
      <.flash
        ...
        hidden
      >
        Espera mientras nos recuperamos
        <.icon name="hero-arrow-path" class="ml-1 h-3 w-3 animate-spin" />
      </.flash>
    </div>
    """
